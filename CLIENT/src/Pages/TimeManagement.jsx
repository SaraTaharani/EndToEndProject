                            ...
                            <tr key={index}>
                                {currentEditId === activityTime.id ? (
                                    <>
                                        <td><input type="text" defaultValue={activityTime.day} id={`day-${activityTime.id}`} /></td>
                                        <td>
                                            <select id={`startHour-${activityTime.id}`} defaultValue={activityTime.startTimeHour}>
                                                {generateOptions(23)}
                                            </select>
                                        </td>
                                        <td>
                                            <select id={`startMinutes-${activityTime.id}`} defaultValue={activityTime.startTimeMinutes}>
                                                {generateOptions(59)}
                                            </select>
                                        </td>
                                        <td>
                                            <select id={`endHour-${activityTime.id}`} defaultValue={activityTime.endTimeHour}>
                                                {generateOptions(23)}
                                            </select>
                                        </td>
                                        <td>
                                            <select id={`endMinutes-${activityTime.id}`} defaultValue={activityTime.endTimeMinutes}>
                                                {generateOptions(59)}
                                            </select>
                                        </td>
                                        <td>
