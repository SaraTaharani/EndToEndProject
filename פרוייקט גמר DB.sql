...
INSERT INTO passwords (userId, password) VALUES
    ...
    (  6,  '$2a$10$rtVqChLqWZrGWMfNULS6/.s2wroiTKnT2PrJP2jHBlO031uyDcEoS' );
...
('2024-06-05', '2024-08-15', 3, 3, 'להתאים את המחשוף', true);
...
-- (4, '2024-06-01', '20:30:00', '22:00:00',90),
-- (4, '2024-06-01', '20:30:00', '22:00:00',90),
(5, '2024-06-01', '20:30:00', '22:00:00',90);CREATE DATABASE IF NOT EXISTS mySql_Project;
